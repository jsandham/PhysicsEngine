...
Component *getInternalComponent(const SceneAllocators &allocators, const SceneIdState &state, const Guid &id, int type);
...
//Entity *loadInternalEntity(World &world, SceneAllocators &allocators, SceneIdState &state, const YAML::Node &in,
//                           const Guid &id);
//
//// Load internal component either from binary or YAML
//Component *loadInternalComponent(World &world, SceneAllocators &allocators, SceneIdState &state, const YAML::Node &in,
...
//Entity *destroyInternalEntity(SceneAllocators &allocators, SceneIdState &state, const Guid &entityId, int index);
//Component *destroyInternalComponent(SceneAllocators &allocators, SceneIdState &state, const Guid &entityId,
