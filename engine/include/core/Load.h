...
namespace PhysicsEngine
{
	...
	Asset* loadAsset(std::unordered_map<int, Allocator*>* allocatorMap, std::vector<char> data, int type, int* index);

	// load external components defined by the user (components with type 20 or greater)
	Component* loadComponent(std::unordered_map<int, Allocator*>* allocatorMap, std::vector<char> data, int type, int* index);

	// load external systems defined by the user (systems with type 10 or greater)
	System* loadSystem(std::unordered_map<int, Allocator*>* allocatorMap, std::vector<char> data, int type, int* index);
