...
#include "../../Renderer.h"
#include "RenderContextDirectX.h"
	...
	class DirectXRenderer : public Renderer
	{
      ...
      protected:
        ...
        void writePixelsTexture3D_impl(TextureFormat format, int width, int height, int depth,
                                       const std::vector<unsigned char> &data, unsigned int tex) override;
        void createCubemap_impl(TextureFormat format, TextureWrapMode wrapMode, TextureFilterMode filterMode, int width,
                                const std::vector<unsigned char> &data, unsigned int *tex) override;
        ...
        void updateCubemap_impl(TextureWrapMode wrapMode, TextureFilterMode filterMode, int anisoLevel,
                                unsigned int tex) override;
        void readPixelsCubemap_impl(TextureFormat format, int width, int numChannels, std::vector<unsigned char> &data,
                                    unsigned int tex) override;
