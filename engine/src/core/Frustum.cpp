...
bool Frustum::containsPoint(glm::vec3 point) const
{
	...
	if (mPlanes[0].signedDistance(point) < 0) { return false; }
	if (mPlanes[1].signedDistance(point) < 0) { return false; }
	if (mPlanes[2].signedDistance(point) < 0) { return false; }
	if (mPlanes[3].signedDistance(point) < 0) { return false; }
	if (mPlanes[4].signedDistance(point) < 0) { return false; }
	if (mPlanes[5].signedDistance(point) < 0) { return false; }
