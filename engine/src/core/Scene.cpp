...
// manager.loadShader("standard", "../data/shaders/standard_directional.vs",
// "../data/shaders/standard_directional.frag"); manager.loadShader("particle",
// "../data/shaders/particle_directional.vs", "../data/shaders/particle_directional.frag"); manager.loadShader("basic",
// "../data/shaders/basic.vs", "../data/shaders/basic.frag"); manager.loadShader("basic2", "../data/shaders/basic2.vs",
// "../data/shaders/basic2.frag"); manager.loadShader("line", "../data/shaders/line.vs", "../data/shaders/line.frag");
