...
Component *PhysicsEngine::getInternalComponent(const SceneAllocators &allocators, const SceneIdState &state,
...
//}
//
//Entity *loadEntityFromYAML(World &world, SceneAllocators &allocators, SceneIdState &state, const YAML::Node &in,
//                           const Guid id)
//{
//    return PhysicsEngine::loadInternalEntity(world, allocators, state, in, id);
//}
//
//Component *loadComponentFromYAML(World &world, SceneAllocators &allocators, SceneIdState &state, const YAML::Node &in,
//                                 const Guid id, int type)
//{
...
//}
//
//Object *loadSceneObjectFromYAML(World &world, SceneAllocators &allocators, SceneIdState &state, const YAML::Node &in)
//{
...
//}
//
//template <class T> void loadSceneObjects(World &world, SceneAllocators &allocators, SceneIdState &state, T &in)
//{
//    // if (!in.IsMap()) {
//    //    return;// false;
//    //}
...
//
//template <class T>
//Scene *loadInternalScene_Impl(World &world, SceneAllocators &allocators, SceneIdState &state, T &in, const Guid &id)
//{
...
//
//template <class T>
//Entity *loadInternalEntity_Impl(World &world, SceneAllocators &allocators, SceneIdState &state, T &in, const Guid &id)
//{
...
//
//template <class T>
//Component *loadInternalComponent_Impl(World &world, SceneAllocators &allocators, SceneIdState &state, T &in,
//                                      const Guid &id, int type)
//{
//    if (type == ComponentType<Transform>::type)
//    {
...
//}
//
//Scene *PhysicsEngine::loadInternalScene(World &world, SceneAllocators &allocators, SceneIdState &state,
//                                        const YAML::Node &in, const Guid &id)
//{
//    return loadInternalScene_Impl<const YAML::Node>(world, allocators, state, in, id);
//}
//
//Entity *PhysicsEngine::loadInternalEntity(World &world, SceneAllocators &allocators, SceneIdState &state,
//                                          const YAML::Node &in, const Guid &id)
//{
//    return loadInternalEntity_Impl<const YAML::Node>(world, allocators, state, in, id);
//}
//
//Component *PhysicsEngine::loadInternalComponent(World &world, SceneAllocators &allocators, SceneIdState &state,
...
//}
//
//Entity *PhysicsEngine::destroyInternalEntity(SceneAllocators &allocators, SceneIdState &state, const Guid &entityId,
//                                             int index)
//{
...
//}
//
//Component *PhysicsEngine::destroyInternalComponent(SceneAllocators &allocators, SceneIdState &state,
