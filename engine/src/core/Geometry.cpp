...
float Geometry::EPSILON = 0.0001f;

// Moller-Trumbore algorithm
//https://www.scratchapixel.com/lessons/3d-basic-rendering/ray-tracing-rendering-a-triangle/moller-trumbore-ray-triangle-intersection
bool Geometry::intersect(Ray ray, Triangle triangle)
{
...
bool Geometry::intersect(Ray ray, Plane plane)
{
...
bool Geometry::intersect(Ray ray, AABB aabb)
{
...
bool Geometry::intersect(Ray ray, Frustum frustum)
{
...
bool Geometry::intersect(Sphere sphere, Sphere sphere2)
{
...
bool Geometry::intersect(Sphere sphere, AABB aabb)
{
...
bool Geometry::intersect(Sphere sphere, Frustum frustum)
{
...
bool Geometry::intersect(AABB aabb, AABB aabb2)
{
...
bool Geometry::intersect(AABB aabb, Capsule capsule)
{
	return true;
}

bool Geometry::intersect(AABB aabb, Frustum frustum)
{
	for (int i = 0; i < 6; i++) {
