...
Texture::Texture(World *world, const Id &id) : Asset(world, id)
{
}

Texture::Texture(World *world, const Guid &guid, const Id &id) : Asset(world, guid, id)
{
}
...
TextureHandle* Texture::getNativeGraphics() const
{
    return mTex;
}
