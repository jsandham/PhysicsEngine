...
//#include "../../include/graphics/OpenGLGraphics.h"
//
//using namespace PhysicsEngine;
//
//void OpenGLGraphics::checkError(long line, const char* file)
//{
//    GLenum error;
...
//}
//
//void OpenGLGraphics::checkFrambufferError(long line, const char* file)
//{
...
//}
//
//GLenum OpenGLGraphics::getTextureFormat(TextureFormat format)
//{
...
//}
//
//GLint OpenGLGraphics::getTextureWrapMode(TextureWrapMode wrapMode)
//{
...
//}
//
//GLint OpenGLGraphics::getTextureFilterMode(TextureFilterMode filterMode)
//{
...
//}
//
//void OpenGLGraphics::beginQuery(GLuint queryId)
//{
//    glBeginQuery(GL_TIME_ELAPSED, queryId);
//}
//
//void OpenGLGraphics::endQuery(GLuint queryId, GLuint64* elapsedTime)
//{
//    glEndQuery(GL_TIME_ELAPSED);
//    glGetQueryObjectui64v(queryId, GL_QUERY_RESULT, elapsedTime);
//}
//
//void OpenGLGraphics::createGlobalCameraUniforms(CameraUniform& uniform)
//{
...
//
//    OpenGLGraphics::checkError(__LINE__, __FILE__);
//}
//
//void OpenGLGraphics::createGlobalLightUniforms(LightUniform& uniform)
//{
//    glGenBuffers(1, &uniform.mBuffer);
//    glBindBuffer(GL_UNIFORM_BUFFER, uniform.mBuffer);
...
//}
//
//void OpenGLGraphics::setGlobalCameraUniforms(const CameraUniform& uniform)
//{
//    glBindBuffer(GL_UNIFORM_BUFFER, uniform.mBuffer);
//    glBindBufferRange(GL_UNIFORM_BUFFER, 0, uniform.mBuffer, 0, 144);
...
//}
//
//void OpenGLGraphics::setGlobalLightUniforms(const LightUniform& uniform)
//{
//    glBindBuffer(GL_UNIFORM_BUFFER, uniform.mBuffer);
...
//}
//
//void OpenGLGraphics::createScreenQuad(GLuint* vao, GLuint* vbo)
//{
...
//}
//
//void OpenGLGraphics::renderScreenQuad(GLuint vao)
//{
//    glBindVertexArray(vao);
...
//}
//
//void OpenGLGraphics::createFramebuffer(int width, int height, GLuint* fbo, GLuint* color, GLuint* depth)
//{
...
//
//    OpenGLGraphics::checkFrambufferError(__LINE__, __FILE__);
//
//    glBindFramebuffer(GL_FRAMEBUFFER, 0);
//}
//
//void OpenGLGraphics::destroyFramebuffer(GLuint* fbo, GLuint* color, GLuint* depth)
//{
...
//}
//
//void OpenGLGraphics::bindFramebuffer(GLuint fbo)
//{
//    glBindFramebuffer(GL_FRAMEBUFFER, fbo);
//}
//
//void OpenGLGraphics::unbindFramebuffer()
//{
//    glBindFramebuffer(GL_FRAMEBUFFER, 0);
//}
//
//void OpenGLGraphics::clearFrambufferColor(const Color& color)
//{
//    glClearColor(color.r, color.g, color.b, color.a);
//    glClear(GL_COLOR_BUFFER_BIT);
//}
//
//void OpenGLGraphics::clearFrambufferColor(float r, float g, float b, float a)
//{
//    glClearColor(r, g, b, a);
//    glClear(GL_COLOR_BUFFER_BIT);
//}
//
//void OpenGLGraphics::clearFramebufferDepth(float depth)
//{
//    glClearDepth(depth);
//    glClear(GL_DEPTH_BUFFER_BIT);
//}
//
//void OpenGLGraphics::setViewport(int x, int y, int width, int height)
//{
//    glViewport(x, y, width, height);
//}
//
//void OpenGLGraphics::createTargets(CameraTargets* targets, Viewport viewport, glm::vec3* ssaoSamples, GLuint* queryId0,
//    GLuint* queryId1)
//{
...
//}
//
//void OpenGLGraphics::destroyTargets(CameraTargets* targets, GLuint* queryId0, GLuint* queryId1)
//{
//    // detach textures from their framebuffer
//    glBindFramebuffer(GL_FRAMEBUFFER, targets->mMainFBO);
//    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, 0, 0);
...
//}
//
//void OpenGLGraphics::resizeTargets(CameraTargets* targets, Viewport viewport, bool* viewportChanged)
//{
...
//}
//
//void OpenGLGraphics::readColorPickingPixel(const CameraTargets* targets, int x, int y, Color32* color)
//{
//    glBindFramebuffer(GL_FRAMEBUFFER, targets->mColorPickingFBO);
...
//}
//
//void OpenGLGraphics::createTargets(LightTargets* targets, ShadowMapResolution resolution)
//{
//    GLsizei res = 512;
//    switch (resolution)
//    {
...
//}
//
//void OpenGLGraphics::destroyTargets(LightTargets* targets)
//{
//    // detach textures from their framebuffer
//    for (int i = 0; i < 5; i++)
//    {
...
//}
//
//void OpenGLGraphics::resizeTargets(LightTargets* targets, ShadowMapResolution resolution)
//{
//    GLsizei res = 512;
//    switch (resolution)
//    {
...
//}
//
//void OpenGLGraphics::createTexture2D(TextureFormat format, TextureWrapMode wrapMode, TextureFilterMode filterMode, int width,
//    int height, const std::vector<unsigned char>& data, GLuint* tex)
//{
//    glGenTextures(1, tex);
//    glBindTexture(GL_TEXTURE_2D, *tex);
//
//    GLenum openglFormat = OpenGLGraphics::getTextureFormat(format);
//    GLint openglWrapMode = OpenGLGraphics::getTextureWrapMode(wrapMode);
//    GLint openglFilterMode = OpenGLGraphics::getTextureFilterMode(filterMode);
//
...
//}
//
//void OpenGLGraphics::destroyTexture2D(GLuint* tex)
//{
//    glDeleteTextures(1, tex);
//}
//
//void OpenGLGraphics::updateTexture2D(TextureWrapMode wrapMode, TextureFilterMode filterMode, int anisoLevel, GLuint tex)
//{
//    GLint openglWrapMode = OpenGLGraphics::getTextureWrapMode(wrapMode);
//    GLint openglFilterMode = OpenGLGraphics::getTextureFilterMode(filterMode);
//
...
//}
//
//void OpenGLGraphics::readPixelsTexture2D(TextureFormat format, int width, int height, int numChannels,
...
//}
//
//void OpenGLGraphics::writePixelsTexture2D(TextureFormat format, int width, int height, const std::vector<unsigned char>& data,
//    GLuint tex)
//{
//    glBindTexture(GL_TEXTURE_2D, tex);
//
...
//}
//
//void OpenGLGraphics::createTexture3D(TextureFormat format, TextureWrapMode wrapMode, TextureFilterMode filterMode, int width,
...
//}
//
//void OpenGLGraphics::destroyTexture3D(GLuint* tex)
//{
//    glDeleteTextures(1, tex);
//}
//
//void OpenGLGraphics::updateTexture3D(TextureWrapMode wrapMode, TextureFilterMode filterMode, int anisoLevel, GLuint tex)
//{
//    GLint openglWrapMode = OpenGLGraphics::getTextureWrapMode(wrapMode);
//    GLint openglFilterMode = OpenGLGraphics::getTextureFilterMode(filterMode);
//
...
//}
//
//void OpenGLGraphics::readPixelsTexture3D(TextureFormat format, int width, int height, int depth, int numChannels,
//    std::vector<unsigned char>& data, GLuint tex)
//{
//    glBindTexture(GL_TEXTURE_3D, tex);
//
...
//}
//
//void OpenGLGraphics::writePixelsTexture3D(TextureFormat format, int width, int height, int depth,
...
//}
//
//void OpenGLGraphics::createCubemap(TextureFormat format, TextureWrapMode wrapMode, TextureFilterMode filterMode, int width,
//    const std::vector<unsigned char>& data, GLuint* tex)
//{
//    glGenTextures(1, tex);
...
//}
//
//void OpenGLGraphics::destroyCubemap(GLuint* tex)
//{
//    glDeleteTextures(1, tex);
//}
//
//void OpenGLGraphics::updateCubemap(TextureWrapMode wrapMode, TextureFilterMode filterMode, int anisoLevel, GLuint tex)
//{
//    GLint openglWrapMode = OpenGLGraphics::getTextureWrapMode(wrapMode);
//    GLint openglFilterMode = OpenGLGraphics::getTextureFilterMode(filterMode);
//
...
//}
//
//void OpenGLGraphics::readPixelsCubemap(TextureFormat format, int width, int numChannels, std::vector<unsigned char>& data,
//    GLuint tex)
//{
//    glBindTexture(GL_TEXTURE_CUBE_MAP, tex);
//
...
//}
//
//void OpenGLGraphics::writePixelsCubemap(TextureFormat format, int width, const std::vector<unsigned char>& data, GLuint tex)
//{
//    glBindTexture(GL_TEXTURE_CUBE_MAP, tex);
//
//    GLenum openglFormat = OpenGLGraphics::getTextureFormat(format);
...
//}
//
//void OpenGLGraphics::createMesh(const std::vector<float>& vertices, const std::vector<float>& normals,
...
//}
//
//void OpenGLGraphics::destroyMesh(GLuint* vao, GLuint* vbo0, GLuint* vbo1, GLuint* vbo2)
//{
...
//}
//
//void OpenGLGraphics::createSprite(GLuint* vao)
//{
//    // configure VAO/VBO
//    unsigned int vbo;
//    float vertices[] = {
...
//}
//
//void OpenGLGraphics::destroySprite(GLuint* vao)
//{
//    glDeleteVertexArrays(1, vao);
//}
//
//bool OpenGLGraphics::compile(const std::string& vert, const std::string& frag, const std::string& geom, int* program)
//{
...
//}
//
//int OpenGLGraphics::findUniformLocation(const char* name, int program)
//{
//    return glGetUniformLocation(program, name);
//}
//
//int OpenGLGraphics::getUniformCount(int program)
//{
//    GLint uniformCount;
...
//}
//
//int OpenGLGraphics::getAttributeCount(int program)
//{
...
//}
//
//std::vector<Uniform> OpenGLGraphics::getUniforms(int program)
//{
//    GLint uniformCount;
//    glGetProgramiv(program, GL_ACTIVE_UNIFORMS, &uniformCount);
//
...
//}
//
//std::vector<Attribute> OpenGLGraphics::getAttributes(int program)
//{
//    GLint attributeCount;
//    glGetProgramiv(program, GL_ACTIVE_ATTRIBUTES, &attributeCount);
//
...
//}
//
//void OpenGLGraphics::setUniformBlock(const char* blockName, int bindingPoint, int program)
//{
...
//}
//
//void OpenGLGraphics::use(int program)
//{
//    glUseProgram(program);
//}
//
//void OpenGLGraphics::unuse()
//{
//    glUseProgram(0);
//}
//
//void OpenGLGraphics::destroy(int program)
//{
//    glDeleteProgram(program);
//}
//
//void OpenGLGraphics::setBool(int nameLocation, bool value)
//{
//    glUniform1i(nameLocation, (int)value);
//}
//void OpenGLGraphics::setInt(int nameLocation, int value)
//{
//    glUniform1i(nameLocation, value);
//}
//
//void OpenGLGraphics::setFloat(int nameLocation, float value)
//{
//    glUniform1f(nameLocation, value);
//}
//
//void OpenGLGraphics::setColor(int nameLocation, const Color& color)
//{
//    glUniform4fv(nameLocation, 1, static_cast<const GLfloat*>(&color.r));
//}
//
//void OpenGLGraphics::setVec2(int nameLocation, const glm::vec2& vec)
//{
//    glUniform2fv(nameLocation, 1, &vec[0]);
//}
//
//void OpenGLGraphics::setVec3(int nameLocation, const glm::vec3& vec)
//{
//    glUniform3fv(nameLocation, 1, &vec[0]);
//}
//
//void OpenGLGraphics::setVec4(int nameLocation, const glm::vec4& vec)
//{
//    glUniform4fv(nameLocation, 1, &vec[0]);
//}
//
//void OpenGLGraphics::setMat2(int nameLocation, const glm::mat2& mat)
//{
//    glUniformMatrix2fv(nameLocation, 1, GL_FALSE, &mat[0][0]);
//}
//
//void OpenGLGraphics::setMat3(int nameLocation, const glm::mat3& mat)
//{
//    glUniformMatrix3fv(nameLocation, 1, GL_FALSE, &mat[0][0]);
//}
//
//void OpenGLGraphics::setMat4(int nameLocation, const glm::mat4& mat)
//{
//    glUniformMatrix4fv(nameLocation, 1, GL_FALSE, &mat[0][0]);
//}
//
//void OpenGLGraphics::setTexture2D(int nameLocation, int texUnit, int tex)
//{
...
//}
//
//bool OpenGLGraphics::getBool(int nameLocation, int program)
//{
//    int value = 0;
...
//}
//
//int OpenGLGraphics::getInt(int nameLocation, int program)
//{
//    int value = 0;
//    glGetUniformiv(program, nameLocation, &value);
//
...
//}
//
//float OpenGLGraphics::getFloat(int nameLocation, int program)
//{
//    float value = 0.0f;
...
//}
//
//Color OpenGLGraphics::getColor(int nameLocation, int program)
//{
...
//}
//
//glm::vec2 OpenGLGraphics::getVec2(int nameLocation, int program)
//{
...
//}
//
//glm::vec3 OpenGLGraphics::getVec3(int nameLocation, int program)
//{
...
//}
//
//glm::vec4 OpenGLGraphics::getVec4(int nameLocation, int program)
//{
...
//}
//
//glm::mat2 OpenGLGraphics::getMat2(int nameLocation, int program)
//{
...
//}
//
//glm::mat3 OpenGLGraphics::getMat3(int nameLocation, int program)
//{
...
//}
//
//glm::mat4 OpenGLGraphics::getMat4(int nameLocation, int program)
//{
...
//}
//
//int OpenGLGraphics::getTexture2D(int nameLocation, int texUnit, int program)
//{
//    int tex = -1;
//    glActiveTexture(GL_TEXTURE0 + texUnit);
...
//}
//
//void OpenGLGraphics::applyMaterial(const std::vector<ShaderUniform>& uniforms, const std::vector<int>& textures,
//    int shaderProgram)
//{
//    int textureUnit = 0;
//    for (size_t i = 0; i < uniforms.size(); i++)
//    {
//        if (uniforms[i].mType == UniformType::Sampler2D/*GL_SAMPLER_2D*/)
//        {
//            if (textures[textureUnit] != -1)
//            {
//                OpenGLGraphics::setTexture2D(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram), textureUnit,
//                    textures[textureUnit]);
//            }
//            else
//            {
//                OpenGLGraphics::setTexture2D(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram), textureUnit, 0);
//            }
//
//            textureUnit++;
//        }
//        else if (uniforms[i].mType == UniformType::Int/*GL_INT*/)
//        {
//            OpenGLGraphics::setInt(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram),
//                *reinterpret_cast<const int*>(uniforms[i].mData));
//        }
//        else if (uniforms[i].mType == UniformType::Float/*GL_FLOAT*/)
//        {
//            OpenGLGraphics::setFloat(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram),
//                *reinterpret_cast<const float*>(uniforms[i].mData));
//        }
//        else if (uniforms[i].mType == UniformType::Vec2/*GL_FLOAT_VEC2*/)
//        {
//            OpenGLGraphics::setVec2(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram),
//                *reinterpret_cast<const glm::vec2*>(uniforms[i].mData));
//        }
//        else if (uniforms[i].mType == UniformType::Vec3/*GL_FLOAT_VEC3*/)
//        {
//            OpenGLGraphics::setVec3(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram),
//                *reinterpret_cast<const glm::vec3*>(uniforms[i].mData));
//        }
//        else if (uniforms[i].mType == UniformType::Vec4/*GL_FLOAT_VEC4*/)
//        {
//            OpenGLGraphics::setVec4(findUniformLocation(uniforms[i].mName.c_str(), shaderProgram),
...
//}
//
//void OpenGLGraphics::render(int start, int count, int vao, bool wireframe)
//{
//    if (wireframe)
//    {
...
//}
//
//void OpenGLGraphics::render(const RenderObject& renderObject, OpenGLGraphicsQuery& query)
//{
//    GLsizei numVertices = renderObject.size / 3;
//
//    OpenGLGraphics::render(renderObject.start / 3, numVertices, renderObject.vao);
//
//    query.mNumDrawCalls++;
