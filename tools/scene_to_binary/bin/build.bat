...
set GLEW="C:\Users\James\Documents\PhysicsEngine\engine\include\glew-2.1.0"
...
set CompilerFlags= /MDd -Oi -W4 -wd4201 -wd4189 -wd4100 -wd4530 -wd4996 -wd4127 -wd4211 -wd4512 -Zi /Fo"obj"\ /Fd"obj"\
...
copy "C:\Users\James\Documents\PhysicsEngine\engine\lib\engine.lib" "C:\Users\James\Documents\PhysicsEngine\tools\scene_to_binary\bin"

:: compile project c++ files to obj
cl /c /I%PROJECT% /I%ENGINE% /I%GLEW% /I%CUDA% %CompilerFlags% ..\..\..\sample_project\Demo\Demo\src\Load.cpp
cl /c /I%PROJECT% /I%ENGINE% /I%GLEW% /I%CUDA% %CompilerFlags% ..\..\..\sample_project\Demo\Demo\src\LogicSystem.cpp
cl /c /I%PROJECT% /I%ENGINE% /I%GLEW% /I%CUDA% %CompilerFlags% ..\..\..\sample_project\Demo\Demo\src\PlayerSystem.cpp

:: compile editor c++ files to obj
cl /c /I%PROJECT% /I%ENGINE% /I%GLEW% /I%CUDA% %CompilerFlags% ..\scene_to_binary_main.cpp
