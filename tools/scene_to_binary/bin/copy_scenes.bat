...
rem copy "bundle.assets" "C:\Users\jsand\Documents\PhysicsEngine\sample_project\Demo\x64\Debug"
rem copy "bundle.assets" "C:\Users\jsand\Documents\PhysicsEngine\sample_project\Demo\x64\Release"
