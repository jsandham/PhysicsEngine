...
cl /c /I"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v7.5\include" /I%GLEW% %CompilerFlags% %Win32% ..\src\Scene.cpp ..\src\cuda\Util.cpp %Core% %Asset% %Entities% %Components% %Systems% %Graphics% %Memory%
