...
rem set Systems=..\src\systems\System.cpp ..\src\systems\RenderSystem.cpp ..\src\systems\PhysicsSystem.cpp ..\src\systems\PlayerSystem.cpp ..\src\systems\DebugSystem.cpp ..\src\systems\CleanUpSystem.cpp
...
rem set SystemsObj=System.obj RenderSystem.obj PhysicsSystem.obj PlayerSystem.obj DebugSystem.obj CleanUpSystem.obj
...
cl /c /I"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v7.5\include" /I%GLEW% %CompilerFlags% %Win32% ..\src\cuda\Util.cpp %Core% %Entities% %Components%

:: link 
rem link %LinkerFlags% %CoreObj% %EntitiesObj% %ComponentsObj% %SystemsObj% %GraphicsObj% %Win32Obj% %CudaObj% %SolversObj% Util.obj %Libs%
link %LinkerFlags% %CoreObj% %EntitiesObj% %ComponentsObj% %Win32Obj% Util.obj %Libs%
