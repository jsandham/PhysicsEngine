...
set CompilerFlags= -Oi -W4 -wd4201 -wd4189 -wd4100 -wd4530 -wd4996 -Zi /I%GLEW% /I%CUDA%
...
set Cuda= ..\src\cuda\fluid_kernels.cu ..\src\cuda\cloth_kernels.cu

set CoreObj= Octtree.obj Physics.obj Log.obj Input.obj Time.obj Sphere.obj Bounds.obj Ray.obj Line.obj Capsule.obj Geometry.obj Frustum.obj Mesh.obj
set AssetObj= MeshLoader.obj TextureLoader.obj
set EntitiesObj= Entity.obj
set ComponentsObj= Component.obj Cloth.obj Fluid.obj Joint.obj HingeJoint.obj SpringJoint.obj Camera.obj Collider.obj BoxCollider.obj SphereCollider.obj CapsuleCollider.obj Transform.obj Rigidbody.obj DirectionalLight.obj SpotLight.obj PointLight.obj MeshRenderer.obj LineRenderer.obj
set SystemsObj= System.obj RenderSystem.obj PhysicsSystem.obj PlayerSystem.obj DebugSystem.obj CleanUpSystem.obj
set GraphicsObj = Buffer.obj Color.obj VertexArrayObject.obj UniformBufferObject.obj Texture.obj Cubemap.obj Texture2D.obj Texture3D.obj Framebuffer.obj OpenGL.obj GraphicState.obj Shader.obj ShaderUniformState.obj Material.obj stb_image_implementation.obj
set MemoryObj= Manager.obj Pool.obj
set Win32Obj= win32_main.obj
set CudaObj= fluid_kernels.obj cloth_kernels.obj CudaPhysics.obj
...
cl /c /I%CUDA% /I%GLEW% %CompilerFlags% %Win32% ..\src\Scene.cpp ..\src\cuda\Util.cpp %Core% %Asset% %Entities% %Components% %Systems% %Graphics% %Memory%
...
::Buffer.obj Color.obj VertexArrayObject.obj UniformBufferObject.obj Texture.obj Cubemap.obj Texture2D.obj Texture3D.obj Framebuffer.obj OpenGL.obj GraphicState.obj Shader.obj ShaderUniformState.obj Material.obj stb_image_implementation.obj

::%CoreObj% %AssetObj% %EntitiesObj% %ComponentsObj% %SystemsObj% %GraphicsObj% %MemoryObj% %CudaObj% %Libs% 


::kernel32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib
::Scene.obj %CoreObj% %AssetObj% %EntitiesObj% %ComponentsObj% %SystemsObj% %GraphicsObj% %MemoryObj% %CudaObj%
popd
