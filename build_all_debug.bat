...
cd "%~dp0\engine\lib"
call "build_engine.bat" /debug /omp /O0
cd "..\.."

echo [94mBuilding editor...[0m
cd "%~dp0\editor\bin"
call "build_editor.bat" /debug /O0
cd "..\.."