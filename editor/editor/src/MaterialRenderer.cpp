...
void MaterialRenderer::init()
{
    ...
    mesh.load(PhysicsEngine::InternalMeshes::sphereVertices, PhysicsEngine::InternalMeshes::sphereNormals,
    ...
    GL_DYNAMIC_DRAW); glEnableVertexAttribArray(2); glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 2 *
    sizeof(GL_FLOAT), 0);
