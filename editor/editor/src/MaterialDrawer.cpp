                            ...
                            Guid id)
{
    ...
    // std::to_string(previewWorld.getNumberOfAssets<Mesh>()) + "\n").c_str()); Log::info(("material view world shader
    ...
    // "\n").c_str()); Log::info(("material view world entity count: " +
    // std::to_string(previewWorld.getNumberOfEntities()) + "\n").c_str()); Log::info(("material view world material
    // count: " + std::to_string(previewWorld.getNumberOfAssets<Material>()) + "\n").c_str()); Log::info(("material view
    // world mesh count: " + std::to_string(previewWorld.getNumberOfAssets<Mesh>()) + "\n").c_str());
    // Log::info(("material view world shader count: " + std::to_string(previewWorld.getNumberOfAssets<Shader>()) +
    // "\n").c_str()); Log::info(("material view world texture count: " +
    // std::to_string(previewWorld.getNumberOfAssets<Texture2D>()) + "\n").c_str());
...
//	Log::info("\n");
//	Log::info(("material view world system count: " + std::to_string(previewWorld.getNumberOfSystems()) +
//"\n").c_str()); 	Log::info(("material view world entity count: " + std::to_string(previewWorld.getNumberOfEntities())
//+
//"\n").c_str()); 	Log::info(("material view world material count: " +
// std::to_string(previewWorld.getNumberOfAssets<Material>()) + "\n").c_str()); 	Log::info(("material view world mesh
// count: " + std::to_string(previewWorld.getNumberOfAssets<Mesh>()) + "\n").c_str()); 	Log::info(("material view world
// shader count: " + std::to_string(previewWorld.getNumberOfAssets<Shader>()) + "\n").c_str()); 	Log::info(("material
// view world texture count: " + std::to_string(previewWorld.getNumberOfAssets<Texture2D>()) + "\n").c_str());
//
//	RenderSystem* renderSystem = previewWorld.getSystem<RenderSystem>();
//
//	GraphicsTargets targets = renderSystem->getGraphicsTargets();
//
//	ImGuiWindowFlags window_flags = ImGuiWindowFlags_None;// ImGuiWindowFlags_HorizontalScrollbar | (disable_mouse_wheel
//? ImGuiWindowFlags_NoScrollWithMouse : 0); 	ImGui::BeginChild("MaterialPreviewWindow",
// ImVec2(ImGui::GetWindowContentRegionWidth(), ImGui::GetWindowContentRegionWidth()), true, window_flags);
//	ImGui::Image((void*)(intptr_t)targets.mColor, ImVec2(ImGui::GetWindowContentRegionWidth(),
// ImGui::GetWindowContentRegionWidth()), ImVec2(1, 1), ImVec2(0, 0)); 	ImGui::EndChild();
//}
...
//"\n").c_str()); 	Log::info(("material view world mesh count: " + std::to_string(viewWorld.getNumberOfAssets<Mesh>())
//+
//"\n").c_str()); 	Log::info(("material view world shader count: " +
// std::to_string(viewWorld.getNumberOfAssets<Shader>()) + "\n").c_str()); 	Log::info(("material view world texture
// count: " + std::to_string(viewWorld.getNumberOfAssets<Texture2D>()) + "\n").c_str());*/
//
