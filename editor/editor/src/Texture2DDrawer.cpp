...
void Texture2DDrawer::render(World *world, EditorProject &project, EditorScene &scene, EditorClipboard &clipboard,
                             Guid id)
{
    ...
    // Draw texture child window
    {
        ...
        ImGui::Image((void *)(intptr_t)texture->getNativeGraphics(),
