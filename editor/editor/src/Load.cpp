...
Asset *PhysicsEngine::loadAsset(std::unordered_map<int, Allocator *> *allocatorMap, const std::vector<char> &data,
                                int type, int *index)
{
    return NULL;
}

Component *PhysicsEngine::loadComponent(std::unordered_map<int, Allocator *> *allocatorMap,
                                        const std::vector<char> &data, int type, int *index)
{
    return NULL;
}

System *PhysicsEngine::loadSystem(std::unordered_map<int, Allocator *> *allocatorMap, const std::vector<char> &data,
                                  int type, int *index)
{
    if (type == SystemType<EditorCameraSystem>::type)
    {
