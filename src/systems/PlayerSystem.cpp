...
const GLfloat PlayerSystem::PAN_SENSITIVITY = 0.01f;
const GLfloat PlayerSystem::SCROLL_SENSITIVITY = 0.001f;
const GLfloat PlayerSystem::TRANSLATE_SENSITIVITY = 0.05f;
