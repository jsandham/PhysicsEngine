...
echo [92mCompiling C++ googletest code...[0m
for /R "../src" %%f in (*.cc) do (
	call cl /c /I%INCLUDE_DIR% /I%SRC_DIR% %OPT% %WARN% %MODEFLAGS% %FLAGS% %%f
)
...
:: create static googletest library
echo [92mCreating static googletest library...[0m
lib /out:%MODE%/googletest.lib %OBJ_FILES%
