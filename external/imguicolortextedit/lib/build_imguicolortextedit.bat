...
:: compile c++ code
echo [92mCompiling C++ imgui color text edit code...[0m
...
:: create static imgui olor text edit library
echo [92mCreating static imguicolortextedit library...[0m
lib /nologo /out:%MODE%/imguicolortextedit.lib %OBJ_FILES%
